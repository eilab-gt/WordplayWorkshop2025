...
def sample_papers_df():
    ...
    return pd.DataFrame({
        ...
        'arxiv_id': ['', '2301.12345', ''],
        'venue': ['International Conference on AI and Games', '', 'Journal of Military AI'],
        'citations': [15, 8, 22],
        'pdf_url': ['', 'https://arxiv.org/pdf/2301.12345.pdf', ''],
        'keywords': ['wargaming; LLM; strategy', 'crisis simulation; GPT-4; agent', 'military; AI; evaluation']
    })
...
def mock_openai_client():
    ...
    mock_client = Mock()
    mock_response = Mock()
    mock_response.choices = [Mock(message=Mock(content='{"venue_type": "conference", "game_type": "matrix", "open_ended": "yes", "quantitative": "yes", "llm_family": "GPT-4", "llm_role": "player"}'))]
...
def mock_arxiv():
    ...
    with patch('arxiv.Search') as mock_search:
        ...
        mock_result.summary = 'We investigate how GPT-4 can serve as an autonomous agent...'
