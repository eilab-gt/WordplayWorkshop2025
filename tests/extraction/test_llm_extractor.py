...
class TestLLMExtractor:
        ...
        with patch("openai.OpenAI", return_value=mock_openai_client):
            ...
            with patch("PyPDF2.PdfReader") as mock_reader:
                ...
                mock_page.extract_text.return_value = (
                    "This is a test PDF about LLM wargaming."
                )
    ...
    def test_extract_single_paper(self, sample_config, temp_dir, mock_openai_client):
        ...
        with patch("openai.OpenAI", return_value=mock_openai_client):
            ...
            with patch.object(
                extractor,
                "_extract_pdf_text",
                return_value="Full paper text about GPT-4 in wargaming",
            ):
    ...
    def test_extract_batch(
        ...
        with patch("openai.OpenAI", return_value=mock_openai_client):
            ...
            # Mock PDF text extraction
            with (
                patch.object(extractor, "_extract_pdf_text", return_value="Paper text"),
    ...
    def test_confidence_scoring(self, sample_config, mock_openai_client):
        ...
        with patch("openai.OpenAI", return_value=mock_openai_client):
            ...
            with patch.object(
                extractor, "_extract_pdf_text", return_value="Full text " * 100
            ):
                ...
                assert result_full.get("extraction_confidence", 0) > result_minimal.get(
