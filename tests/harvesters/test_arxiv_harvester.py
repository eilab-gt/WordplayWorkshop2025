...
class TestArxivHarvester:
    ...
    def test_search_basic(self, mock_search_class, harvester):
        ...
        assert papers[0].arxiv_id == "2301.000011"  # Note: version "v" is removed by the code
    ...
    def test_fetch_tex_source_success(self, mock_get, harvester):
        ...
        mock_response.content = b"\\documentclass{article}\\begin{document}Content\\end{document}"
