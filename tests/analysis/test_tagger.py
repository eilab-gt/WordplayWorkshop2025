...
class TestTagger:
    ...
    def test_tag_failures_multiple(self, sample_config):
        ...
        df = pd.DataFrame({
            ...
            'abstract': ['The model showed both hallucination and bias, with clear data leakage from training.'],
            'failure_modes': ['']
        })
    ...
    def test_llm_detection(self, sample_config):
        ...
        df = pd.DataFrame({
            'screening_id': ['SCREEN_0001', 'SCREEN_0002', 'SCREEN_0003', 'SCREEN_0004'],
            'abstract': [
            ...
            'title': ['GPT-4 Study', 'Claude Research', 'Llama Paper', 'Custom Model']
        })
