...
class ConfigLoader:
    ...
    def _build_config(self) -> Config:
        ...
        config.semantic_scholar_key = self._resolve_env(api_keys.get('semantic_scholar'))
        ...
        # Data file paths
        config.raw_papers_path = Path(paths.get('raw_papers', './data/raw/papers_raw.csv'))
        config.screening_progress_path = Path(paths.get('screening_progress', './data/processed/screening_progress.csv'))
        config.extraction_results_path = Path(paths.get('extraction_results', './data/extracted/extraction.csv'))
        ...
        config.log_format = logging_config.get('format', '%(asctime)s - %(name)s - %(levelname)s - %(message)s')
